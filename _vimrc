...
au FileType python setlocal expandtab shiftwidth=4 tabstop=8 softtabstop=4 nosmartindent cinwords=if,elif,else,for,while,try,except,finally,def,class,with
